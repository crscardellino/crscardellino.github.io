---
title: "Train and visualize a model in TensorFlow (RIO XXV)"
slug: rio-tutorial
---
...
Informáticas de la Universidad Nacional de Río Cuarto", focuses on practical
aspects of implementing and training deep learning models.  We will follow, step
by step, the implementation of neural networks models with TensorFlow and its
comparison with Scikit Learn, focusing on the impact of tuning hyperparameters
and architectures. To keep track of results we will use the visualization tool
...
### [Cristian Cardellino](http://crscardellino.net)
